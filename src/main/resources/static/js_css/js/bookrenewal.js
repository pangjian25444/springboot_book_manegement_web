window.onload=function(){
    $("#example-navbar-collapse ul").children("li:eq(3)").attr("class","active");
};
/*隐藏一些div*/
...
function showReaderBookinfo(result){
    ...
    $.each(bookinfo,function (index,item) {
        ...
        var btn_renew= $("<td></td>").append($("<button></button>").append("续借").attr("bid",item.bid).attr("class","btn btn-primary btn_renew"));
